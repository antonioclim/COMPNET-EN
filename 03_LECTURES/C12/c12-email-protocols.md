...
[FIG] assets/images/fig-email-system.png
...
[FIG] assets/images/fig-smtp-transaction.png
...
The envelope and the message headers serve different purposes and can contain different addresses. The envelope controls routing at the MTA level; the headers are what the recipient sees. Spoofing exploits this separation.

[FIG] assets/images/fig-smtp-envelope-vs-headers.png
...
[FIG] assets/images/fig-mime-multipart.png
...
[FIG] assets/images/fig-pop3-session.png
...
[FIG] assets/images/fig-imap-session-states.png
...
[FIG] assets/images/fig-pop3-vs-imap.png
...
The browser communicates only with the webmail server over HTTPS. The webmail server acts as a gateway: it reads mail via IMAP and sends mail via SMTP on behalf of the user. The user never interacts with mail protocols directly.

[FIG] assets/images/fig-webmail-architecture.png
...
Email security operates at multiple layers. STARTTLS and SMTPS protect the transport channel. SPF validates the sending server, DKIM signs the message content and DMARC defines the policy when either check fails.

[FIG] assets/images/fig-email-security-layers.png
...
The lab scenario deploys all components — SMTP server, IMAP server and webmail front-end — as Docker containers orchestrated with Docker Compose. Students interact with the stack end-to-end: sending, relaying, storing and reading mail within a single isolated environment.

[FIG] assets/images/fig-docker-mailstack.png
