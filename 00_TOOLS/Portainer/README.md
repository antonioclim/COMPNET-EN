...
4. **Suggested instructor phrasing is provided in English.** The GUIDE files include optional instructor phrasing marked with `▸`. Adapt it freely — it is a starting point, not a script.
