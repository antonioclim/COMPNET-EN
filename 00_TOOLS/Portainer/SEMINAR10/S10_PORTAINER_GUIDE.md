...
> *▸ „Tunelul trimite pe portul 9000, Portainer e pe 9050. Sunt porturi complet diferite — aceeași mașină poate găzdui sute de servicii, fiecare pe alt port."*
...
> *▸ „Punct de plecare curat. Un singur container — Portainer însuși."*
...
> *▸ „Docker DNS intern (127.0.0.11) rezolvă `web` la IP-ul containerului. Verificați în Portainer — e același IP."*
...
> *▸ „Verificare rapidă în Portainer: toate containerele DNS au dispărut. Acum putem porni SSH fără conflicte de porturi."*
...
> *▸ „Portul 22 intern e mapat pe 2222 pe host. De aceea ne conectăm cu `-p 2222`."*
...
> *▸ „Priviți: `web` nu are niciun port publicat. Nu-l puteți accesa direct din browser — portul 8000 e doar `expose`, vizibil doar în rețeaua Docker. Singura cale e prin tunelul SSH."*
...
> *▸ „Containerul `web` nu știe că traficul vine printr-un tunel. Vede o cerere HTTP normală. Portainer ne arată exact asta."*
