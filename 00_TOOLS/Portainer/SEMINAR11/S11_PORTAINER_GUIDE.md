...
> *▸ „Patru containere. Doar `nginx-proxy` are port publicat pe host. Backend-urile sunt invizibile din exterior — accesibile doar prin proxy."*
...
> *▸ „Distribuția round-robin în timp real: fiecare backend primește o cerere la rând. Fără Portainer ați avea nevoie de trei ferestre PowerShell cu `docker logs -f`."*
...
> *▸ „Nginx detectează backend-ul picat și îl scoate din rotație. Observați: web2 e oprit, log-urile lui sunt goale."*
...
> *▸ „Dacă `lb-custom` apare roșu, deschideți log-urile — de regulă e o eroare de import sau de sintaxă Python."*
...
> *▸ „Comparați cu Part 1: acolo Nginx asculta pe portul 80 intern, publicat ca 8080. Aici, LB-ul Python ascultă direct pe 8080. Altă implementare, același rol."*
...
> *▸ „Load balancer-ul rezolvă numele containerelor prin Docker DNS — la fel ca Nginx."*
