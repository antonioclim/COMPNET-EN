...
> *▸ „Ca administratori, vedem totul: ce servicii rulează, pe ce porturi, ce imagini folosesc. Atacatorul nu are aceste informații — trebuie să le descopere prin scanning."*
...
> *▸ „Verificăm ca administrator că serviciile funcționează. Un scan care nu găsește nimic poate însemna că serviciul nu e pornit — sau că scanner-ul e greșit. Portainer ne elimină prima posibilitate."*
...
> *▸ „Scanner-ul e pe aceeași rețea ca țintele. De pe host, IP-urile 172.20.0.x nu sunt direct accesibile — dar din container, da."*
...
> *▸ „Din Portainer vedem cum țintele simt scanul. DVWA primește conexiuni noi, vsftpd primește cereri de banner. Acesta e perspectiva apărătorului."*
...
> *▸ „Administratorul cunoaște versiunea din tag-ul imaginii Docker. Atacatorul o deduce din banner. De obicei coincid — de aceea banner-urile sunt o problemă de securitate."*
...
> *▸ „Portul 6200 e portul backdoor-ului din vsftpd 2.3.4. Administratorul îl vede în configurația Docker. Atacatorul îl descoperă cu nmap. Întrebarea e: de ce ascultă ceva pe portul 6200?"*

---

### Closing (minutes 37–40)

> *▸ „Azi am lucrat din două perspective simultan:*
> - *Atacatorul: descoperire prin scanning, enumerare prin bannere, exploatare.*
> - *Administratorul (Portainer): vizibilitate completă, monitorizare log-uri, detectare activitate suspectă.*
>
> *Un administrator bun folosește instrumente de observabilitate — Portainer, Prometheus, Grafana, ELK — ca să vadă ce vede atacatorul, înainte ca atacatorul să vadă."*
